...
const getDepartmentDetails = require("./getDepartmentDetails");
const getProgramdetails = require("./getProgramdetails");
const addStudentHandler = require("./addStudentHandler");
const app = express();
...
app.use("/",getDepartmentDetails);
app.use("/",getProgramdetails);
app.use("/",addStudentHandler);
